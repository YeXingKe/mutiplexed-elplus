    ...
    n('moxie/core/utils/Basic', [], function () {
                        ...
                        for (s = 0; s < f.length; s++)
                          (l = c[++a]),
                            ...
                            typeof u === o && u.length > 0
                              ? 2 == u.length
                                ? (t[u[0]] = typeof u[1] == n ? u[1].call(this, l) : u[1])
                                : 3 == u.length
                                ? (t[u[0]] =
                                    typeof u[1] !== n || (u[1].exec && u[1].test)
                                      ...
                                      : e)
                                : 4 == u.length &&
                                  (t[u[0]] = l ? u[3].call(this, l.replace(u[1], u[2])) : e)
                              : (t[u] = l ? l : e)
                        break
                      }
                    if (c) break
              ...
              use_blob_uri: function () {
                ...
                return (
                  (i.use_blob_uri =
                    ...
                    ('IE' !== a.browser || a.verComp(a.version, '11.0.46', '>='))),
                  i.use_blob_uri
                )
              },
      ...
      n('moxie/core/Exceptions', ['moxie/core/utils/Basic'], function (e) {
        ...
        return {
          ...
          EventException: (function () {
            ...
            return (
              e.extend(t, { UNSPECIFIED_EVENT_TYPE_ERR: 0 }), (t.prototype = Error.prototype), t
            )
          })()
        }
      }),
          ...
          return (
            i.extend(n.prototype, {
              ...
              hasEventListener: function (e) {
                ...
                return (
                  e
                    ? ((e = e.toLowerCase()), (t = r[this.uid] && r[this.uid][e]))
                    : (t = r[this.uid]),
                  t ? t : !1
                )
              },
              removeEventListener: function (e, t) {
                ...
                if ((n = r[this.uid] && r[this.uid][e])) {
                  ...
                  n.length ||
                    (delete r[this.uid][e], i.isEmptyObj(r[this.uid]) && delete r[this.uid])
                }
              },
              ...
              dispatchEvent: function (e) {
                ...
                if ('string' !== i.typeOf(e)) {
                  ...
                  ;(e = s.type),
                    s.total !== u && s.loaded !== u && ((c.total = s.total), (c.loaded = s.loaded)),
                    (c.async = s.async || !1)
                }
                if (
                  (-1 !== e.indexOf('::')
              ...
              (c = (function () {
                ...
                return {
                  exec: function (t, i, n, r) {
                    return c[i] &&
                      (e[t] || (e[t] = { context: this, instance: new c[i]() }), e[t].instance[n])
                      ...
                      (u = n.getConstructor(a))
                        ? ((e = new u(r)),
                          ...
                          e.bind('Exception', function (e, i) {
                            ...
                            s.trigger(
                              'RuntimeError',
                              new t.RuntimeError(t.RuntimeError.EXCEPTION_ERR, n)
                            )
                          }),
                          e.mode ? (e.init(), void 0) : (e.trigger('Error'), void 0))
                        : (o(i), void 0))
                    : (s.trigger('RuntimeError', new t.RuntimeError(t.RuntimeError.NOT_INIT_ERR)),
                      (e = null),
                      void 0)
                }
                var a,
          ...
          function n(o, a) {
            function s(t, i, o) {
              ...
              return 'string' === e.typeOf(s) && s.length
                ? ((a = new n(null, { type: o, size: i - t })), a.detach(s.substr(t, a.size)), a)
                : null
            }
            i.call(this),
        ...
        var i =
          ...
          u = function (i) {
            ...
            return (
              ...
              (r = s(i)),
              n.push({ title: t.translate('Files'), extensions: r.length ? r.join(',') : '*' }),
              n
            )
          },
          c = function (e) {
                ...
                abort: function () {
                  ;(this.result = null),
                    -1 === e.inArray(this.readyState, [a.EMPTY, a.DONE]) &&
                      (this.readyState === a.LOADING && (this.readyState = a.DONE),
                ...
                _.bind('LoadStart', function (e) {
                  ...
                  _.bind('Load', function (t) {
                    i('readyState', h.DONE),
                      ...
                      i(
                        'response',
                        r.exec.call(_, 'XMLHttpRequest', 'getResponse', i('responseType'))
                      ),
                      ~e.inArray(i('responseType'), ['text', ''])
                        ? i('responseText', i('response'))
                        : 'document' === i('responseType') && i('responseXML', i('response')),
            ...
            e.extend(this, I, {
                    ...
                    : U &&
                      ...
                      (R ||
                        ...
                        e.each(U.split(/\r\n/), function (t) {
                          ...
                          2 === i.length &&
                            ((i[0] = e.trim(i[0])),
                            (R[i[0].toLowerCase()] = { header: i[0], value: e.trim(i[1]) }))
                        })),
                      R.hasOwnProperty(t))
              ...
              send: function (i, r) {
                ...
                if (i instanceof s) (k.ruid = i.ruid), (D = i.type || 'application/octet-stream')
                  ...
                  'string' == typeof i &&
                    ((O = 'UTF-8'), (D = 'text/plain;charset=UTF-8'), (i = n.utf8_encode(i)))
                this.withCredentials ||
                  (this.withCredentials =
                    k.required_caps && k.required_caps.send_browser_cookies && !B),
              ...
              destroy: function () {
                _ && ('function' === e.typeOf(_.destroy) && _.destroy(), (_ = null)),
                  this.unbindAll(),
      ...
      n(
        ...
        function (e, t, i, n, r, o, a, s, u, c, l, d, m) {
              ...
              ;(r.name = t.name || ''),
                t.isDetached()
                  ? (this.bind('RuntimeInit', function (e, t) {
                    ...
                    this.connectRuntime(
                      e.extend({ required_caps: { access_image_binary: !0, resize_image: !0 } }, i)
                    ))
              ...
              e.extend(this, {
                ...
                resize: function (t) {
                  ...
                  try {
                    ...
                    if (
                      ((n = (o.meta && o.meta.tiff && o.meta.tiff.Orientation) || 1),
                    ...
                    if (s.crop) {
                      switch (
                        ...
                        t.fit
                          ? ((a.width = Math.min(Math.ceil(s.width / r), o.width)),
                ...
                embed: function (n, r) {
                  function o(t, r) {
                    ...
                    if (u.can('create_canvas')) {
                      ...
                      if (l)
                        return (
                          n.appendChild(l), (l = null), o.destroy(), c.trigger('embedded'), void 0
                        )
                    }
          ...
          return (
            (h.MAX_RESIZE_WIDTH = 8192), (h.MAX_RESIZE_HEIGHT = 8192), (h.prototype = c.instance), h
          )
        }
      ),
      n(
              ...
              l = e.extend(
                {
                  ...
                  filter_by_extension: u(
                    (function () {
                      return !(
                        ...
                        ('Safari' === n.browser && n.verComp(n.version, 11, '<=')) ||
                  ...
                  select_folder: function () {
                    return (
                      o.can('select_file') &&
                      (('Chrome' === n.browser && n.verComp(n.version, 21, '>=')) ||
                        ('Firefox' === n.browser && n.verComp(n.version, 42, '>=')))
                    )
                  },
          ...
          function i() {
            function e(e, t, i) {
              ...
              if (!window.File.prototype.slice)
                return (n = window.File.prototype.webkitSlice || window.File.prototype.mozSlice)
                  ? n.call(e, t, i)
                  : null
              try {
              ...
              init: function (u) {
                ...
                ;(e = u),
                  ...
                  (l.innerHTML =
                    ...
                    (e.directory && g.can('select_folder') ? 'webkitdirectory directory' : '') +
                    (d ? ' accept="' + d.join(',') + '"' : '') +
                    ' />'),
                  (c = n.get(g.uid)),
                  i.extend(c.style, {
                  ...
                  g.can('summon_file_dialog') &&
                    ('static' === n.getStyle(m, 'position') && (m.style.position = 'relative'),
                    r.addEvent(
                      m,
                      'click',
                      function (e) {
                      ...
                      i.each(this.files, function (i) {
                        ...
                        return e.directory && '.' == i.name
                          ...
                          : (i.webkitRelativePath &&
                              (n = '/' + i.webkitRelativePath.replace(/^\//, '')),
                            (i = new t(g.uid, i)),
                            (i.relativePath = n),
                            p.files.push(i),
                            void 0)
                ...
                switch (e) {
                  ...
                  case 'directory':
                    t && i.can('select_folder')
                      ...
                      : (r.removeAttribute('directory'), r.removeAttribute('webkitdirectory'))
                    break
                  case 'multiple':
              ...
              read: function (t, o) {
                ...
                ;(a.result = ''),
                  ...
                  'function' === i.typeOf(n[t])
                    ? ((r = !1), n[t](o.getSource()))
                    : 'readAsBinaryString' === t && ((r = !0), n.readAsDataURL(o.getSource()))
              },
              abort: function () {
                n && n.abort()
              },
          ...
          function c() {
            function e(e, t) {
              ...
              ;(i = t.getBlob().getSource()),
                (n = new window.FileReader()),
                (n.onload = function () {
                  t.append(t.getBlobName(), new o(null, { type: i.type, data: n.result })),
                    f.send.call(r, e, t)
                }),
            ...
            function d(e) {
              ...
              return (
                m.setRequestHeader('Content-Type', 'multipart/form-data; boundary=' + t),
                e.each(function (e, a) {
                  r +=
                    e instanceof o
                      ? i +
            ...
            t.extend(this, {
              send: function (i, r) {
                var s = this,
                  ...
                  p = !1
                if (
                  ((h = i.url.replace(/^.+?\/([\w\-\.]+)$/, '$1').toLowerCase()),
                  (m = c()),
                ...
                m.upload
                  ...
                  '' !== i.responseType &&
                    'responseType' in m &&
                    (m.responseType =
                      'json' !== i.responseType || u.can('return_response_type', 'json')
                        ? i.responseType
                        : 'text'),
                  p
                    ? m.sendAsBinary
            ...
            return (
              r.clear(),
              {
                ...
                restore: function (t) {
                  var i, n, r
                  for (
                    r = new e(t), o = 65504 == r.SHORT(2) ? 4 + r.SHORT(4) : 2, n = 0, i = s.length;
                    i > n;
                    n++
                  )
                ...
                set: function (e, t) {
                  var i,
                    ...
                    o = []
                  for (
                    'string' == typeof t ? o.push(t) : (o = t), i = n = 0, r = s.length;
                    r > i &&
        ...
        function (e, i, n) {
          function r(o) {
            function a(i, r) {
              ...
              for (o = p.SHORT(i), a = 0; o > a; a++)
                if (((g = []), (h = i + 2 + 12 * a), (s = r[p.SHORT(h)]), s !== t)) {
                  if (((u = v[p.SHORT((h += 2))]), (c = p.LONG((h += 2))), (m = w[u]), !m))
                  ...
                  'ASCII' !== u
                    ? ((g = p.asArray(u, h, c)),
                      (f = 1 == c ? g[0] : g),
                      (x[s] = l.hasOwnProperty(s) && 'object' != typeof f ? l[s][f] : f))
            ...
            ;(d.IFD0 = d.tiffHeader + this.LONG((m += 2))),
              ...
              'ExifIFDPointer' in h &&
                ((d.exifIFD = d.tiffHeader + h.ExifIFDPointer), delete h.ExifIFDPointer),
              'GPSInfoIFDPointer' in h &&
                ((d.gpsIFD = d.tiffHeader + h.GPSInfoIFDPointer), delete h.GPSInfoIFDPointer),
          ...
          function n(n) {
            function r() {
              ...
              return (
                (e = a.call(this, 8)),
                'IHDR' == e.type
                  ? ((t = e.start), { width: s.LONG(t), height: s.LONG((t += 4)) })
                  : null
              )
            }
            function o() {
      ...
      n('moxie/runtime/html5/image/ResizerCanvas', [], function () {
        function e(i, n, r) {
          var o = i.width > i.height ? 'width' : 'height',
            a = Math.round(i[o] * n),
            s = !1
          'nearest' !== r && (0.5 > n || n > 2) && ((n = 0.5 > n ? 0.5 : 2), (s = !0))
          var u = t(i, n)
          ...
          function c() {
            ...
            t.extend(this, {
              ...
              loadFromImage: function (e, t) {
                ;(this.meta = e.meta),
                  (y = new o(null, { name: e.name, size: e.size, type: e.type })),
              ...
              resize: function (t, i, n) {
                ...
                if (
                  ...
                  r
                    .getContext('2d')
                    .drawImage(e(), t.x, t.y, t.width, t.height, 0, 0, r.width, r.height),
                  (v = s.scale(r, i)),
                  (_ = n.preserveHeaders),
                  !_)
                ) {
              ...
              getAsBlob: function (e, t) {
                return e !== this.type
                  ? ((b = !0),
                    new o(null, { name: y.name || '', type: e, data: E.getAsDataURL(e, t) }))
                  ...
                  ;(w = l(i)),
                    x &&
                      ...
                      _ &&
                        (x.meta &&
                          x.meta.exif &&
                          x.setExif({ PixelXDimension: this.width, PixelYDimension: this.height }),
                        (w = x.writeHeaders(w))),
                      x.purge(),
                      (x = null))
                }
                ...
                l,
                {
                  ...
                  return_response_type: function (t) {
                    return 'json' === t && window.JSON
                      ? !0
                      : !e.arrayDiff(t, ['', 'text', 'document']) || 'browser' === m.mode
                  },
                  ...
                  init: function () {
                    ...
                    ;(a = this.getShimContainer()),
                      ...
                      (c = setTimeout(function () {
                        m &&
                          !m.initialized &&
                          m.trigger('Error', new n.RuntimeError(n.RuntimeError.NOT_INIT_ERR))
                      }, 5e3))
                  },
                  destroy: (function (e) {
                    return function () {
        ...
        function (e, t) {
          ...
          var n = {
            read: function (e, t) {
              var n,
                r = this.getRuntime()
              return (n = r.shimExec.call(this, 'FileReaderSync', 'readAsBase64', t.uid))
                ? ('readAsDataURL' === e && (n = 'data:' + (t.type || '') + ';base64,' + n),
                  i(n, e, t.type))
                : null
            }
          }
          ...
          function a(e) {
            ...
            try {
              try {
                ...
                if (l) {
                  for (
                    t = l.description, '1.0.30226.2' === t && (t = '2.0.30226.2'), i = t.split('.');
                    i.length > 3;
                    ...
                    ;(e = this.getShimContainer()),
                      ...
                      (l = setTimeout(
                        function () {
                          d &&
                            !d.initialized &&
                            d.trigger('Error', new n.RuntimeError(n.RuntimeError.NOT_INIT_ERR))
                        },
        ...
        function (e, t, i, n) {
          function r(e) {
            for (var t = '', i = 0; i < e.length; i++)
              t +=
                ('' !== t ? '|' : '') + e[i].title + ' | *.' + e[i].extensions.replace(/,/g, ';*.')
            return t
          }
          var o = {
            init: function (e) {
      ...
      n(
        ...
        ['moxie/runtime/silverlight/Runtime', 'moxie/core/utils/Dom', 'moxie/core/utils/Events'],
        function (e, t, i) {
          var n = {
            init: function () {
              var e,
        ...
        function (e, t, i, n) {
          function o(t) {
            ...
            i.call(this, t, a, {
              ...
              access_image_binary: !1,
              display_media: u(
                (n.can('create_canvas') || n.can('use_data_uri_over32kb')) && r('moxie/image/Image')
              ),
              do_cors: !1,
              drag_and_drop: !1,
              filter_by_extension: u(
            ...
            t.extend(this, {
              send: function (d, m) {
                          ...
                          ;(i =
                            ...
                            /^4(0[0-9]|1[0-7]|2[2346])\s/.test(i.title)
                              ...
                              : ((u = 200),
                                ...
                                v.trigger({ type: 'progress', loaded: c.length, total: c.length }),
                                x &&
                                  v.trigger({
                                    type: 'uploadprogress',
                                    loaded: x.size || 1025,
                ...
                if (((u = c = null), m instanceof s && m.hasBlob())) {
                  if (
                    ((x = m.getBlob()), (f = x.uid), (g = i.get(f)), (p = i.get(f + '_form')), !p)
                  )
                    throw new r.DOMException(r.DOMException.NOT_FOUND_ERR)
                } else
                  (f = t.guid('uid_')),
  ...
  !(function (e, i) {
    ...
    function o(t) {
      for (var n = 0; n < t.length; n++) {
        for (var r = e, s = t[n], o = s.split(/[.\/]/), u = 0; u < o.length - 1; ++u)
          r[o[u]] === i && (r[o[u]] = {}), (r = r[o[u]])
        r[o[o.length - 1]] = a[s]
      }
    }
    var a = {}
    r('plupload', [], function () {
      var e = t,
        i = e.core.utils
      return (
        (i.Env.global_event_dispatcher = 'plupload.EventTarget.instance.dispatchEvent'),
        {
          VERSION: '3.1.2',
          STOPPED: 1,
          STARTED: 2,
          ...
          formatSize: function (t) {
            ...
            return t > n
              ? e(t / n, 1) + ' ' + i.translate('tb')
              : t > (n /= 1024)
              ? e(t / n, 1) + ' ' + i.translate('gb')
              : t > (n /= 1024)
              ? e(t / n, 1) + ' ' + i.translate('mb')
              : t > 1024
              ? Math.round(t / 1024) + ' ' + i.translate('kb')
              : t + ' ' + i.translate('b')
          },
          ...
          plupload.extend(this, {
            ...
            add: function (t, e) {
              ...
              return 'object' != typeof t || e
                ? n.hasOwnProperty(t)
                  ? s.update.apply(s, arguments)
                  : ((n[t] = i = e), r++, void 0)
                : plupload.each(t, function (t, e) {
                    s.add(e, t)
                  })
            },
            remove: function (t) {
            ...
            combineWith: function () {
              ...
              return (
                e.add(n),
                plupload.each(arguments, function (i) {
      ...
      r('plupload/core/ArrCollection', ['plupload'], function (t) {
        var e = function () {
          ...
          t.extend(this, {
            ...
            getIdx: function (t) {
              for (var i = 0, n = e.length; n > i; i++) if (e[i].uid === t) return i
              return -1
            },
            getByIdx: function (t) {
              return e[t]
            ...
            splice: function (i, n) {
              return (
                (i = 'undefinded' === t.typeOf(i) ? 0 : Math.max(i, 0)),
                (n = 'undefinded' !== t.typeOf(n) && i + n < e.length ? n : e.length - i),
                e.splice(i, n)
              )
            },
            extract: function (t) {
              ...
              setOption: function (t, i, n) {
                ...
                return 'object' == typeof t
                  ? ((n = i),
                    ...
                    void 0)
                  : ((!n || s._options.hasOwnProperty(t)) &&
                      ((r = e.clone(s._options[t])),
                      'object' === e.typeOf(i) && 'object' === e.typeOf(s._options[t])
                        ? e.extend(s._options[t], i)
                        : (s._options[t] = i),
                      s.trigger('OptionChanged', t, i, r)),
                    void 0)
              },
              getOption: function (t) {
                if (!t) return this._options
                var i = this._options[t]
                return e.inArray(e.typeOf(i), ['array', 'object']) > -1
                  ? e.extendImmutable({}, i)
                  : i
              },
        ...
        return (function (e) {
          ...
          return (
            ...
            t.extend(i.prototype, {
              start: function () {
                var t = this.state
                return this.state === i.PROCESSING
                  ? !1
                  : (this.startedTimestamp || (this.startedTimestamp = +new Date()),
                    (this.state = i.PROCESSING),
                    this.trigger('statechanged', this.state, t),
                    this.trigger('started'),
                    !0)
              },
              pause: function () {
                var e = this.state
                return -1 === t.inArray(this.state, [i.IDLE, i.RESUMED, i.PROCESSING])
                  ? !1
                  : ((this.processed = this.percent = 0),
                    (this.loaded = this.processed),
                    (this.state = i.PAUSED),
                    this.trigger('statechanged', this.state, e),
                    this.trigger('paused'),
                    !0)
              },
              resume: function () {
                var t = this.state
                return this.state !== i.PAUSED && this.state !== i.RESUMED
                  ? !1
                  : ((this.state = i.RESUMED),
                    this.trigger('statechanged', this.state, t),
              ...
              failed: function (t) {
                ...
                return this.state === i.FAILED
                  ...
                  : ((this.processed = this.percent = 0),
                    ...
                    (this.state = i.FAILED),
                    this.trigger('statechanged', this.state, e),
                    this.trigger('failed', t),
                    this.trigger('processed'),
                    !0)
              },
              progress: function (t, e) {
                e && (this.total = e),
                  (this.processed = Math.min(t, this.total)),
                  (this.loaded = this.processed),
                  (this.percent = Math.ceil(100 * (this.processed / this.total))),
                  this.trigger({ type: 'progress', loaded: this.processed, total: this.total })
              },
              destroy: function () {
                var t = this.state
                return this.state === i.DESTROYED
                  ? !1
                  : ((this.state = i.DESTROYED),
                    this.trigger('statechanged', this.state, t),
          ...
          return (function (r) {
            function s(i) {
              r.apply(this, arguments),
                ...
                (this._options = t.extend(
                  {},
                  this._options,
                  { max_slots: 1, max_retries: 0, auto_start: !1, finish_active: !1 },
                  i
                ))
            }
            function o() {
            ...
            return (
              ...
              t.extend(s.prototype, {
                ...
                start: function () {
                  return s.parent.start.call(this) ? a.call(this) : !1
                },
                pause: function () {
                  return s.parent.pause.call(this)
                ...
                stop: function () {
                  return !s.parent.stop.call(this) || this.getOption('finish_active')
                    ? !1
                    : (this.isActive() &&
                        this.forEachItem(function (t) {
                          t.stop()
                ...
                addItem: function (e) {
                  ...
                  e.bind('Started', function () {
                    ...
                    e.bind('Processed Stopped', function () {
                      n.calcStats() &&
                        t.delay.call(n, function () {
                          a.call(n) || this.isStopped() || this.isActive() || n.stop()
                        })
                    }),
                    e.bind('Progress', function () {
                      n.calcStats() &&
                        n.trigger('Progress', n.stats.processed, n.stats.total, n.stats)
                    }),
                    e.bind('Failed', function () {
                      n.getOption('max_retries') &&
                        this.retries < n.getOption('max_retries') &&
                        (this.stop(), this.retries++)
                    }),
                    this._queue.add(e.uid, e),
                    this.calcStats(),
                    e.trigger('Queued'),
                    (n.getOption('auto_start') || n.state === i.PAUSED) &&
                      t.delay.call(this, this.start)
                },
                ...
                isStopped: function () {
                  return this.state === i.IDLE || this.state === i.DESTROYED
                },
                ...
                clear: function () {
                  var t = this
                  return t.state !== i.IDLE
                    ? (t.bindOnce('Stopped', function () {
                        t.clear()
                      }),
                      t.stop())
                    : (t._queue.clear(), t.stats.reset(), void 0)
                },
                calcStats: function () {
                  var t = this,
                    e = t.stats,
                  ...
                  return e
                    ? (e.reset(),
                      t.forEachItem(function (s) {
                        ...
                        ;(n += s.processed),
                          (!s.processedTimestamp || s.processedTimestamp > t.startedTimestamp) &&
                            (r += n),
                          (e.processedPerSec = Math.ceil(
                            r / ((+new Date() - t.startedTimestamp || 1) / 1e3)
                          )),
                          (e.processed = n),
                          (e.total += s.total),
                          e.total && (e.percent = Math.ceil(100 * (e.processed / e.total)))
                      }),
                      (t.percent = e.percent),
                      (e.loaded = e.processed),
                      (e.size = e.total),
                      (e.bytesPerSec = e.processedPerSec),
                      !0)
                    : !1
                },
                destroy: function () {
                  var e = this
                  return e.state === i.DESTROYED
                    ? !1
                    : e.state !== i.IDLE
                    ? (e.bindOnce('Stopped', function () {
                        t.delay.call(e, e.destroy)
                      }),
                      e.stop())
                    : (e.clear(), s.parent.destroy.call(this), (e._queue = e.stats = null), !0)
                }
              }),
              s
            )
          ...
          function n(t) {
            e.call(this, {
              ...
              (this.setOption = function (t, e) {
                'object' != typeof t && 'max_upload_slots' == t && (t = 'max_slots'),
                  n.prototype.setOption.call(this, t, e, !0)
              }),
              this.setOptions(t)
          }
        ...
        return (function (i) {
          function n(t) {
            e.call(this, {
              ...
              (this.setOption = function (t, e) {
                'object' != typeof t && 'max_resize_slots' == t && (t = 'max_slots'),
                  n.prototype.setOption.call(this, t, e, !0)
              }),
              this.setOptions(t)
          }
            ...
            n.call(this),
              ...
              e.extend(this, {
                start: function () {
                  ...
                  this.startedTimestamp || (this.startedTimestamp = +new Date()),
                    (this.state = n.PROCESSING),
                    this.trigger('statechanged', this.state, p),
                    (a = new s()),
                    a.upload &&
                      (a.upload.onprogress = function (t) {
                        l.progress(t.loaded, t.total)
                      }),
                    (a.onload = function () {
                      var t = {
                  ...
                  try {
                    ;(r = c.multipart ? c.url : i(c.url, c.params)),
                      a.open(c.http_method, r, !0),
                      e.isEmptyObj(c.headers) ||
                        e.each(c.headers, function (t, e) {
                          a.setRequestHeader(e, t)
                        }),
                      c.multipart
                        ? ((u = new o()),
                          e.isEmptyObj(c.params) ||
                            e.each(c.params, function (t, e) {
                              u.append(e, t)
                            }),
                          u.append(c.file_data_name, t),
                          a.send(u))
                        : ((e.isEmptyObj(c.headers) || !a.hasRequestHeader('content-type')) &&
        ...
        function (t, e, i, n) {
          function r(s, o) {
            ...
            var l = new e(),
              p = 1
            i.call(this),
              (this._options = { chunk_size: 0, params: {}, send_file_name: !0, stop_on_fail: !0 }),
              t.extend(this, {
                name: s.name,
                start: function () {
                  var t,
                  ...
                  return this.state === i.PROCESSING
                    ...
                    : (this.startedTimestamp || (this.startedTimestamp = +new Date()),
                      (this.state = i.PROCESSING),
                      this.trigger('statechanged', this.state, r),
                      e._options.send_file_name &&
                        (e._options.params.name = e.target_name || e.name),
                      e._options.chunk_size
                        ? ((p = Math.ceil(s.size / e._options.chunk_size)), e.uploadChunk(!1, !0))
                        : ((t = new n(s)),
                ...
                uploadChunk: function (e, r) {
                  var c,
                    ...
                    g = {}
                  return (
                    (g.seq = parseInt(e, 10) || u()),
                    (g.start = g.seq * f),
                    (g.end = Math.min(g.start + f, s.size)),
                    (g.total = s.size),
                    g.start < 0 || g.start >= s.size
                      ? !1
                      : ((d = t.extendImmutable({}, this.getOptions(), {
                          params: { chunk: g.seq, chunks: p }
                        })),
                        (c = new n(s.slice(g.start, g.end, s.type))),
                        c.bind('progress', function (t) {
                          h.progress(a() + t.loaded, s.size)
                        }),
                        c.bind('failed', function (e, n) {
                          l.add(g.seq, t.extend({ state: i.FAILED }, g)),
                            h.trigger('chunkuploadfailed', t.extendImmutable({}, g, n)),
                            d.stop_on_fail && h.failed(n)
                        }),
                        c.bind('done', function (e, n) {
                          l.add(g.seq, t.extend({ state: i.DONE }, g)),
                            h.trigger('chunkuploaded', t.extendImmutable({}, g, n)),
                            a() >= s.size
                              ? (h.progress(s.size, s.size), h.done(n))
                              : r &&
                                t.delay(function () {
                                  h.uploadChunk(u(), r)
                                })
                        ...
                        c.setOptions(d),
                        l.add(g.seq, t.extend({ state: i.PROCESSING }, g)),
                        o.addItem(c),
                        r && o.countSpareSlots() && h.uploadChunk(u(), r),
                        !0)
                  )
                },
                destroy: function () {
        ...
        function n(t) {
          i.call(this),
            ...
            (this.setOption = function (t) {
              ;('object' == typeof t || this._options.hasOwnProperty(t)) &&
                n.prototype.setOption.apply(this, arguments)
            }),
            (this.start = function (e) {
              var i,
                n = this
              e && this.setOptions(e.resize),
                (i = new r()),
                i.bind('load', function () {
                  this.resize(n.getOptions())
                }),
                i.bind('resize', function () {
                  n.done(this.getAsBlob(n.getOption('type'), n.getOption('quality'))),
                    this.destroy()
                }),
      ...
      r(
        'plupload/File',
        ['plupload', 'plupload/core/Queueable', 'plupload/FileUploader', 'plupload/ImageResizer'],
        function (t, e, i, n) {
          function r(a, u, l) {
            e.call(this),
              t.extend(this, {
                ...
                start: function () {
                  var i = this.state
                  return this.state === e.PROCESSING
                    ? !1
                    : ((this.state = e.PROCESSING),
                      this.trigger('statechanged', this.state, i),
                      this.trigger('started'),
                      !t.isEmptyObj(this._options.resize) &&
                      s(this.type) &&
                      o(a, 'send_binary_string')
        ...
        function (e, i, n, r, s, o) {
          function a(i) {
            ...
            function d(i) {
              ...
              e.each(n.getOption('runtimes').split(/\s*,\s*/), function (t) {
                ...
                n.getOption('browse_button') &&
                  e.each(n.getOption('browse_button'), function (i) {
                    s.push(function (s) {
                      var a = new t.file.FileInput(
                        e.extend({}, o, {
                      ...
                      ;(a.onready = function () {
                        ...
                        a.bind('mouseenter mouseleave mousedown mouseup', function (t) {
                          R ||
                            (n.getOption('browse_button_hover') &&
                              ('mouseenter' === t.type
                                ? e.addClass(i, n.getOption('browse_button_hover'))
                                : 'mouseleave' === t.type &&
                                  e.removeClass(i, n.getOption('browse_button_hover'))),
                            n.getOption('browse_button_active') &&
                              ('mousedown' === t.type
                                ? e.addClass(i, n.getOption('browse_button_active'))
                                : 'mouseup' === t.type &&
                                  e.removeClass(i, n.getOption('browse_button_active'))))
                        }),
                ...
                n.getOption('drop_element') &&
                  e.each(n.getOption('drop_element'), function (i) {
                    s.push(function (s) {
            ...
            function m(t, i) {
              i.code === e.INIT_ERROR
                ? t.destroy()
                : i.code === e.HTTP_ERROR && t.state == e.STARTED && t.trigger('CancelUpload')
            }
            function _(t) {
              ...
              e.extend(this, {
                ...
                init: function () {
                  ...
                  return (
                    ...
                    c.call(n),
                    e.each(['container', 'browse_button', 'drop_element'], function (t) {
                      return null === n.getOption(t)
                        ? ((i = {
                            code: e.INIT_ERROR,
                    ...
                    i
                      ? n.trigger('Error', i)
                      : n.getOption('browse_button') || n.getOption('drop_element')
                      ? (d.call(n, function (t) {
                          var i,
                            o = n.getOption('init'),
                          ...
                          'function' == typeof o
                            ...
                            t
                              ? ((E = !0),
                                (i = e.Runtime.getInfo(u())),
                                (y = new r(a)),
                                (v = new s(a)),
                                n.trigger('Init', { ruid: i.uid, runtime: (n.runtime = i.type) }),
                                n.trigger('PostInit'))
                              : n.trigger('Error', {
                                  code: e.INIT_ERROR,
                ...
                setOption: function (t, i) {
                  return E &&
                    ...
                    : ('object' != typeof t &&
                        ((i = p(t, i, this._options)),
                        y && y.setOption(t, i),
                        v && v.setOption(t, i)),
                      a.prototype.setOption.call(this, t, i),
                      void 0)
                },
                refresh: function () {
                  O.length &&
                    ...
                    t.bind('beforestart', function (t) {
                      ...
                      t.bind('failed', function (t, i) {
                        p.trigger(
                          'Error',
                          e.extend(
                            { code: e.HTTP_ERROR, message: e.translate('HTTP Error.'), file: this },
                            i
                          )
                        )
                      })
                      ...
                      c.push(function (t) {
                        s(i, function (s) {
                          ...
                          s ||
                            ...
                            p.addItem(a),
                            d.push(a),
                            p.trigger('FileFiltered', a)),
                            e.delay(t)
                        })
                      })
                    } else
                      i instanceof t.file.Blob
                        ? (a(i.getSource()), i.destroy())
                        : -1 !== e.inArray(u, ['file', 'blob'])
                        ? a(new t.file.File(null, i))
                        : 'node' === u && 'filelist' === e.typeOf(i.files)
                        ? e.each(i.files, a)
                        : 'array' === u && ((n = null), e.each(i, a))
                  }
                  var l,
                    p = this,
                    c = [],
                ...
                splice: function () {
                  ...
                  if (r.length) {
                    for (
                      this.trigger('FilesRemoved', r), i && this.stop(), t = 0;
                      t < r.length;
                      t++
                    )
                      r[t].destroy()
          ...
          function u(t) {
            ...
            return (
              'string' == typeof n
                ...
                : n === !0 &&
                  (t.chunk_size && t.chunk_size > 0 && (r.slice_blob = !0),
                  (e.isEmptyObj(t.resize) && t.multipart !== !1) || (r.send_binary_string = !0),
                  t.http_method && (r.use_http_method = t.http_method),
                  e.each(t, function (t, e) {
                    i(e, !!t, !0)
                  })),
              r
          ...
          function p(t, i, n) {
            switch (t) {
              ...
              case 'filters':
                return (
                  'array' === e.typeOf(i) && (i = { mime_types: i }),
                  i.mime_types &&
                    ('string' === e.typeOf(i.mime_types) &&
                      (i.mime_types = e.mimes2extList(i.mime_types)),
                    (n.re_ext_filter = (function (t) {
                      var i = []
                      return (
                        e.each(t, function (t) {
          ...
          function d(t, i) {
            ...
            return (
              (n = new a(t)),
              (r = e.Runtime.thatCan(n.getOption('required_features'), i || t.runtimes)),
              n.destroy(),
              r
            )
          }
          var h,
            f = {}
          return (
            c('mime_types', function (t, i, n) {
              t.length && !this.getOption('re_ext_filter').test(i.name)
                ? (this.trigger('Error', {
            ...
            c('prevent_duplicates', function (t, i, n) {
              ...
              t &&
                this.forEachItem(function (t) {
                  return i.name === t.name && i.size === t.size
                    ? (r.trigger('Error', {
            ...
            c('prevent_empty', function (t, i, n) {
              t && !i.size && i.size !== h
                ? (this.trigger('Error', {
                    code: e.FILE_SIZE_ERROR,
                    message: e.translate('File size error.'),
