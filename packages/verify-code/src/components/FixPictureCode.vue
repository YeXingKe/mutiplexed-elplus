...
export default {
  ...
  methods: {
    ...
    handleMoveEvent: throttle(function (e, type = 'mouse') {
      ...
      const moveX =
        type === 'mouse' ? e.clientX - this.originX : e.changedTouches[0].pageX - this.originX
      const moveY =
        type === 'mouse' ? e.clientY - this.originY : e.changedTouches[0].pageY - this.originY
...
.slide-verify-refresh-icon {
  ...
  height: 34px;
  cursor: pointer;
  background: url('../assets/bg.jpg') 0 -437px;
...
.slide-verify-slider-mask-item-icon {
  ...
  width: 14px;
  height: 12px;
  background: url('../assets/bg.jpg') 0 -26px;
  background-size: 34px 471px;
}
